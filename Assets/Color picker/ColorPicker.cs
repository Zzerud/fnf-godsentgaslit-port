...
public class ColorPicker : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public static Color left;
    public static Color right;
    public static Color up;
    public static Color down;
    public ControllManager.Key key;

    [SerializeField] private Shader colorPickerShader;
    ...
    private void ApplyColor(bool doCallback = true)
    {
        ...
        switch (key)
        {
            case ControllManager.Key.left:
                left = Color.HSVToRGB(h, s, v);
                break;
            case ControllManager.Key.right:
                right = Color.HSVToRGB(h, s, v);
                break;
            case ControllManager.Key.up:
                up = Color.HSVToRGB(h, s, v);
                break;
            case ControllManager.Key.down:
                down = Color.HSVToRGB(h, s, v);
                break;
            default:
                break;
        }
